...
.empCard0_1{width:100%;float: left;background: white;height:60%}
.empCard0_1_1{margin-left:0px; width:49%;float: left;height:100%}
.empCard0_1_2{margin-left:0px; width:49%;float: right;height:100%}

.empCard0_space{width:100%;float: left;border: 0px solid gray;background: white;height:2%}

.empCard0_2{width:100%;float: left;border: 0px solid gray;background: white;height:38%}
...
td.details-control1 {
    ...
    background: url('https://img.icons8.com/?size=1x&id=7914&format=png') no-repeat center center;
    cursor: pointer;
}
tr.shown td.details-control1 {
    background: url('https://img.icons8.com/?size=1x&id=FcnDmZ6bSl2G&format=png') no-repeat center center;
}  
</style>
   	...
   	<div  class="empCard0">
	   	<div  class="empCard0_1">
		   	<div  class="empCard0_1_1">
		   		<!-- <div class="panelContainer">노선별 위반비율</div> -->		
		   		<div id="title_route" class="panelContainer">노선별집계현황</div>	
		   	...
		   	<div  class="empCard0_1_2">
		   		<!-- <div id="title_emp" class="panelContainer">기준</div> -->	
			    <table id="empTable" class="drivingAnal  cell-border nowrap" >  
				    <thead>
				        <tr > 
				            <th>no.</th>
				            <th>기사별순위</th>
		   	...
		   	<div  class="empCard0_space">
			</div>
	
	   	<div  class="empCard0_2">
	   		<!-- <div class="panelContainer">일별 위반내역</div> -->		
	   		<div id="title_detail" class="panelContainer">일일상세내역</div>	
