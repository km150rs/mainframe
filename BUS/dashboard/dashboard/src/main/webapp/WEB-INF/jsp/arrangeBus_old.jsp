...
<script src="/resources/static/js/messagebox.min.js"></script>
<link href="/resources/static/css/messagebox.min.css" rel="stylesheet" type="text/css" />
...
span2 {
	...
	<div style="margin:2px;height:50px;width:99.6%;border: 1px solid gray">
		<table  style="color:black;width:100%;">
		  <tr class="form-group">
		    ...
		    <td style = "text-align:right;width:64%">
			    ...
			    <input class="pjy_btn_query pjy_button_fixed" type="button" tabindex="7" id="btnSave" value="배차확정" disabled>
			    <input class="pjy_btn_query pjy_button_unfixed" type="button" tabindex="8" id="btnSaveCancel" value="배차확정취소" disabled>
			</td>
		  </tr>
		 </table>
   	...
   	<div class="dynamicSqlGrid0_2_2" style="visibility:hidden">
   		<div class="dynamicSqlGrid0_2_2_1" >
			...
			<div class="status-color" style="height:625px;background:silver">
			    <div class=tabContainerCompl>
				    <ul class="tabs_svc2">
				        <li id="svc_tablink21" class="active2"> <a href="#svc_tab21">전월근무현황</a></li>
				        <li id="svc_tablink22" > <a href="#svc_tab22">예비기사LIST</a></li>
				        <li id="svc_tablink23" > <a href="#svc_tab23">요일별근무간격</a></li>
				        <li id="svc_tablink24" > <a href="#svc_tab24">근태현황</a></li>
				    </ul>
			...
			<div class="status-color" style="height:190px;margin-top:10px">
				<div class=tabContainerCompl>
				    <ul class="tabs_svc3">
				        <li id="svc_tablink31" class="active3"> <a href="#svc_tab31">기준월배차상태</a></li>
				        <li id="svc_tablink32" > <a href="#svc_tab32">전체노선감차설정</a></li>
				    </ul>
	...
	<div class="popup" data-popup="example"> <!-- 표출되는 팝업 입니다. --> 
		<div class="popup-inner"> 
			<div class="popup-contents"> 
				<p class="txtBlack2" >배차진행현황</p>
			</div>
			<div class="popup-contents"> 
				<a class="popup-close" data-popup-close="example" href="#">close</a> <!-- 팝업 닫기 버튼입니다 -->
			</div>
		    <div>
				<table id = "TBM_MONTH_ARRANGE_STATUS_POPUP" class="table">
							<thead>
					        <tr >
					            <th>노선</th>
					            <th>상태</th>
