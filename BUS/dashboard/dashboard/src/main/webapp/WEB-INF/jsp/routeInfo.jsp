...
<script src="/monitor/routeInfo.js"></script>
...
<!-- 	
	<div class="arrangeViewGrid0_2_2" >
		<div id="tabs">
		  <ul>
		    <li><a href="#tabs-1">배차순별거리</a></li>
		  </ul>
		  <div id="tabs-1">
			<div style="overflow:hidden;height:40px;width:99.6%">
				<table  style="width:100%;">
				  <tr class="form-group">
				    ...
				    <td style = "text-align:right;width:52%">
						<div class="filebox">
					    	<input class="pjy_btn_small pjy_button_unfixed" type="button" id="btnViewDistance" value="조회">
							<input class="pjy_btn_small pjy_button_unfixed" type="button" id="btnSaveDistance" value="저장">
						</div>
					</td>
				  </tr>
				 </table>		  
				...
				<div class="dynamicSqlGrid0_2_2">
			    	<table id="distancetable" class="QueryResultGrid cell-border ">	    		</table>
			  </div>
		  </div>
