...
<script src="/monitor/empWorkingLog.js"></script>
		  ...
		  <tr class="form-group">
		  	...
		  	<td style = "text-align:center;width:2%">  
				<div  class="tui-datepicker-input tui-datetime-input tui-has-focus">
		            <input type="text" id="fromDate" aria-label="Date-Time" autocomplete="off">
		  	...
		  	<td style = "text-align:center;width:2%">  
				<div  class="tui-datepicker-input tui-datetime-input tui-has-focus">
		            <input type="text" id="toDate" aria-label="Date-Time" autocomplete="off">
		            <span class="tui-ico-date"></span>
		        </div>				  
			...
			<td style="text-align:right;width:2%">			  
			    <input class="pjy_btn_small" type="button" tabindex="9" id="btnCommonCode" value="분류코드.." >
			</td>
