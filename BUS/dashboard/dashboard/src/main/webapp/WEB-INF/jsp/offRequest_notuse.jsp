...
<script src="/monitor/offRequest.js"></script>
...
<!-- 
 ...
 -->
	    ...
	    <td style = "text-align:left;width:25%">휴가구분 :
		  <select id="comboOffRequestType">
...
<div class="empInfo0_2_2">
	<table id="offRequestTable" class="cell-border pjy_inputGrid" >
	    <thead>
	        <tr > 
	        	<th></th>
	            <th>시작일자</th>
