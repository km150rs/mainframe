...
<script src="/monitor/publicComplaint.js"></script>
...
<script src="/resources/static/js/ColReorderWithResize.js"></script>
		  ...
		  <tr class="form-group">
		  	...
		  	<td style = "text-align:center;width:2%">  
				<div  class="tui-datepicker-input tui-datetime-input tui-has-focus">
		            <input type="text" id="fromYm" aria-label="Date-Time" autocomplete="off">
		  	...
		  	<td style = "text-align:center;width:2%">  
				<div  class="tui-datepicker-input tui-datetime-input tui-has-focus">
		            <input type="text" id="toYm" aria-label="Date-Time" autocomplete="off">
		            <span class="tui-ico-date"></span>
		        </div>				  
...
<!-- 		    
			    <input type="file" id="excelfile" />  
   				...
   				<input class="pjy_btn_query" type="button" id="viewfile" value="Export To Table" onclick="ExportToTable()" />
   				 -->  
			    <input class="pjy_btn_query" type="button" id="btnValidationCheck" value="사전점검">
