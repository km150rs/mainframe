			...
			$.ajax({
			       ...
			       success : function(ret) {	
					   //console.log(ret);
			    	    ...
			    	    //console.log(ret.data);
			    	    var height= $('.empCard0_1').height() - 25;
						fn_setGridData('#dangerStepTable',newColumns,ret.data,height,false);
			       },
			       error : function(request, status, error) {
			    	   swal(request.responseText,'error');
			       }
			...
			$.ajax({
			       ...
			       success : function(ret) {	
					   //console.log(ret);
			    	    ...
			    	    //console.log(newColumns);
			    	    //console.log(ret.data);
			    	    var height= $('.empCard0_2').height() - 50;
						fn_setGridData('#dangerDriverTable',newColumns,ret.data,height,true);
			       },
			       error : function(request, status, error) {
			    	   swal(request.responseText,'error');
			       }
			       ...
			       success : function(ret) {	
					   //console.log(ret);
						for (var i = 0; i < ret.header.length; i++) {
  			    	    ...
  			    	    var height= $('.empCard0_3').height() - 50;

		    	        fn_setGridData('#dangerEmpTable',columns,ret.data,height,true);
