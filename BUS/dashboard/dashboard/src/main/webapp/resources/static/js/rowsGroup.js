    ...
    RowsGroup.prototype = {
        ...
        _getOrderWithGroupColumns: function(order, groupedColumnsOrderDir) {
            ...
            var groupedColumnsOrder = groupedColumnsIndexes.map(function(iColumn) {
                ...
                if (iInOrderIndexes >= 0) return [iColumn, groupedColumnsKnownOrder[iInOrderIndexes][1]]
        ...
        _updateOrderAndDrawFirst: function() {
            this.mergeCellsNeeded = true;
            // var currentOrder = this.table.order();
            // currentOrder = this._getInjectedMonoSelectWorkaround(currentOrder);
            // this.order = this._getOrderWithGroupColumns(currentOrder)
