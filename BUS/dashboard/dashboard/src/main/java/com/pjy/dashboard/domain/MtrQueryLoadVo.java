...
@AllArgsConstructor
@NoArgsConstructor
public class MtrQueryLoadVo implements Serializable{
	   /**
	 * 
	 */
	...
	*/
	@Getter
	private  final String MtrIP_dev = "192.168.225.21";

	@Getter
	private  final String MtrIP_nfoss1 = "172.29.41.102";

	@Getter
	private  final String MtrIP_nfoss2 = "172.29.41.103";
