package com.pjy.dashboard.core.error;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleMetaDataAccessException(final MetaDataAccessException e) {
        log.error("MetaDataAccessException", e);
        final ErrorResponse response = ErrorResponse.of(ErrorCode.INVALID_META);
