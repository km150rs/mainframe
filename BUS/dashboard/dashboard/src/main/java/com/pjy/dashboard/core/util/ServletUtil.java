...
public class ServletUtil {
    ...
    public static Boolean isLastDate(String chkDate) {
    	LocalDate today = LocalDate.now();
    	
    	Calendar cal = Calendar.getInstance();
    	cal.set(today.getYear(),today.getMonthValue()-1,1);
    	int lastDay = cal.getActualMaximum(Calendar.DATE);
    	String lastDate = String.format("%04d%02d%02d", today.getYear(),today.getMonthValue()-1,lastDay);
    	
    	return chkDate.equals(lastDate);
    }
}