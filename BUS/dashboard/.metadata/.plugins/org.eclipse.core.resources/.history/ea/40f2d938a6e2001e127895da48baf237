...
<script src="/monitor/employeeInfo.js"></script>
...
.empInfo0_2_2{width:99.7%;border: 0px solid gray;height:100% ;}
.QueryResultGrid{
	...
	<div style="margin:2px;overflow:hidden;height:50px;width:99.6%;border: 1px solid gray">
		<table  style="width:100%;">
		  <tr class="form-group">
		  	<td style = "text-align:left;width:20%">  
		  		<h4>사원정보 Excel Upload</h4>
		  	</td>
...
<!-- 		    
   	...
   	<div class="empInfo0_2_2">
	    <table id="exceltable" class=" cell-border nowrap">  </table>
