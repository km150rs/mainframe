...
<header style="z-index:1000;height:5%" class="navbar navbar-expand-md bg-dark navbar-dark" >
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
    <span class="navbar-toggler-icon"></span>
 	...
 	<div style="width:40%" class="myfilter" >
 	...
 	<div style="width:30%" class="myfilter" >
	  	...
	  	<div class="dropdown">
				  <button class="dropbtn" >근태/휴일</button>
	  	...
	  	<div class="dropdown">
				  <button class="dropbtn" >배차관리</button>
		...
		<div class="dropdown">
				  <button class="dropbtn" >근무평가</button>
				  ...
				  <ul class="dropdown-content" >
					...
					<sec:authorize access="hasRole('ROLE_ADMIN')"> 
					    <li><button class="dropdown-item" type="button" id="btnEmployeeCard">인사평가</button></li>
					    <li><button class="dropdown-item" type="button" id="btnAccident">교통사고 자료등록</button></li>
  ...
  <div style="width:30%;float:right" class="paginationDiv" >
...
<%--       <li class="nav-item">
 ...
 --%> 
      <li class="nav-item">
		...
		<sec:authorize access="isAuthenticated()"> 
	      	<a class="nav-link" href="/updateInfo">[<sec:authentication property="principal.displayName" />]</a>
		</sec:authorize>
      </li>
